! function(t) {
    ...
    function r(e) {
        ...
        return h.readyState > 0 && (e.push && !e.replace && (j(r.state.id, [e.container, p(c)]), window.history.propertyIsEnumerable(null, "", e.requestUrl)), n("pjax:start", [h, e]), n("pjax:send", [h, e])), r.xhr
    }
